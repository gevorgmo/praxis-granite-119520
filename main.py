...
class MyHandler(webapp2.RequestHandler):
	...
	if user:
		email=user.email()
		acc='@google.com,alex.denholm@gluttony.com,william.elfast@roundheadinteractive.com,gevorg.manukyan@roundheadinteractive.com,gevorgmo@gmail.com,alex.robete@gluttony.com,honor@personafilms.com,ahonor@gmail.com,nick.rhodes@gluttony.com,will.elfast@gluttony.com'
		if acc.find(email)==-1 :
			self.send_error(403, "Forbidden")
			print  errmsg1,'<p>You are signed in as <b>',email,'</b>. <a href="', users.create_logout_url('/'),'">Switch Accounts</a></p>',errmsg2
			sys.exit()
	else:
		self.send_error(403, "Forbidden")
		print errmsg1, errmsg2
		sys.exit()
	...
	print """
		...
		<html lang='en'>
		<head>
		<title>Google Lookbook test</title>
		...
		<body>
			<header><div class='header-user-content'>Welcome, 
			"""
	print email, '! (<a href="',users.create_logout_url('/'),'">Log Out</a>)</div></header>'
	print """	
		<div class='top_title'>
