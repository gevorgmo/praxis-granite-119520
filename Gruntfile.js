module.exports = function(grunt) {
  ...
  grunt.initConfig({
    appengine: {
      app: {
        ...
        manageScript: ['C:/Program Files (x86)/Google/google_appengine', 'appcfg.py'].join('/'),
        runFlags: {
          port: 8080
        },
        runScript: ['C:/Program Files (x86)/Google/google_appengine', 'dev_appserver.py'].join('/')
      }
    },
    ...
    closureBuilder: {
      options: {
        ...
        compile: true,
        compilerFile: ['google_closure', 'compiler.jar'].join('/'),
        compilerOpts: {
    ...
    closureSoys: {
      all: {
        ...
        soyToJsJarPath: ['google_closure_templates',
    ...
    copy: {
      ...
      soyutils: {
        cwd: ['google_closure_templates'].join('/'),
      ...
      public: {
        cwd: 'public',
        dest: [targetDirectory, 'public', ''].join('/'),
        expand: true,
        src: '**'
      },
      templates: {
  ...
  grunt.registerTask('default',
      ['copy:source',  'copy:templates','copy:public',
