...
_UNAUTHENTICATED_ROUTES = [('/', example_handlers.LookbookHandler)]

# These should all inherit from base.handlers.BaseAjaxHandler
_UNAUTHENTICATED_AJAX_ROUTES = [('/', example_handlers.LookbookHandler)]

# These should all inherit from base.handlers.AuthenticatedHandler
_USER_ROUTES = [('/', example_handlers.LookbookHandler),
('/start', example_handlers.LookbookHandler),
('/select_region', example_handlers.LookbookHandler),
('/channels', example_handlers.LookbookHandler),
('/beauty_and_fashion', example_handlers.LookbookHandler),
('/comedy', example_handlers.LookbookHandler),
('/entertainment_and_pop_culture', example_handlers.LookbookHandler),
('/parenting_and_family', example_handlers.LookbookHandler),
('/music', example_handlers.LookbookHandler),
('/video_gaming', example_handlers.LookbookHandler),
('/cars_trucks_and_racing', example_handlers.LookbookHandler),
('/food_and_recipes', example_handlers.LookbookHandler),
('/news', example_handlers.LookbookHandler),
('/science_and_education', example_handlers.LookbookHandler),
('/sports', example_handlers.LookbookHandler),
('/technology', example_handlers.LookbookHandler),
('/spanish_language', example_handlers.LookbookHandler),
('/breakout_videos', example_handlers.LookbookHandler),
('/end', example_handlers.LookbookHandler)
]
